...
const uni = graduates.filter(element => element.university.includes('Uni')).map(el => el.university);
console.log(uni);
...
*/
const populationTotal = zooAnimals.reduce((acc, currentValue) => acc + currentValue.population
,0);
